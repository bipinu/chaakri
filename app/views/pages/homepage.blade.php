@include( 'layouts.user-facing.header')

<div class="row">
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany"><span class = "jobLogo"><img src = "assets/images/logos/devthon.png"></span></li>
                <li  class = "jobTitle">
                    <h1>Pizza Guy</h1>
                </li>
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <span class = "jobLogo"><img src = "assets/images/logos/devthon.png"></span>
                </li>
                <li  class = "jobTitle">
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <span class = "jobLogo"><img src = "assets/images/logos/zurilabs.png"></span>
                </li>
                <li  class = "jobTitle">
...
<div class="row">
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <span class = "jobLogo"><span class = "jobLogo"><img src = "assets/images/logos/devthon.png"></span></span>
                </li>
                <li  class = "jobTitle">
                    <h1>Community Manager</h1>
                </li>
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <span class = "jobLogo"><span class = "jobLogo"><img src = "assets/images/logos/zurilabs.png"></span></span>
                </li>
                <li  class = "jobTitle">
                    <h1>Vice President, Products</h1>
                </li>
...
<div class="row">
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany"><img src = "assets/images/logos/devthon.png"></li>
                <li  class = "jobTitle">
                    <h1>Pizza Guy</h1>
                </li>
                <li class = "jobLocation">Hyderabad</li>
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <img src = "assets/images/logos/devthon.png">
                </li>
                <li  class = "jobTitle">
                    <h1>Community Manager</h1>
                </li>
    ...
    <div class="col-lg-4">
        <div class = "chaakriJob">
            <ul>
                <li  class = "jobCompany">
                    <img src = "assets/images/logos/zurilabs.png">
                </li>
                <li  class = "jobTitle">
                    <h1>Vice President, Products</h1>
                </li>
...
@include( 'layouts.user-facing.footer')
